...
def predict(model, image_data, image, show_image, output_path):
  ...
  visualize.show_detections(
    ...
    image = image,
    scored_boxes_by_class_index = scored_boxes_by_class_index,
    class_index_to_name = dogcat.Dataset.class_index_to_name
  )
...
if __name__ == "__main__":
  ...
  group.add_argument("--eval", action = "store_true", 
        help = "Evaluate model")
  group.add_argument("--dump-anchors", metavar = "dir", action = "store", 
  ...
  group.add_argument("--predict-to-file", metavar = "url", action = "store", type = str, 
        help = "Run inference on image and render detected boxes to 'predictions.png'" )
  group.add_argument("--predict-all", metavar = "name", action = "store", type = str, 
  ...
  parser.add_argument("--backbone", metavar = "model", action = "store", default = "vgg16", 
    ...
    # Output & Logging
  parser.add_argument("--save-to", metavar = "file", action = "store", 
        help = "Save final trained weights to file" )
  ...
  parser.add_argument("--log-csv", metavar = "file", action = "store", 
        help = "Log training metrics to CSV file" )
  
    # Dataset Configuration
  parser.add_argument("--dataset-dir", metavar = "dir", action = "store", default = "VOCdevkit/VOC2007", 
  ...
  parser.add_argument("--periodic-eval-samples", metavar = "count", action = "store", type = int, default = 1000, 
